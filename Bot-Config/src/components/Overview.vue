...
export default {
  ...
  methods: {
     ...
     */
    fetchData () {
      fetch('http://141.19.145.162:3000/api/v1/manage/bot/', {
        headers: {
    ...
    toggle (bot) {
      ...
      let url = `http://141.19.145.162:3000/api/v1/manage/bot/${bot.id}/${action}`
     ...
     */
    remove (bot) {
      let url = `http://141.19.145.162:3000/api/v1/manage/bot/${bot.id}`
