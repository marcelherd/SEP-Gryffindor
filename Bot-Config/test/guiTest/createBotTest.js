...
driver.sleep(1000)
driver.findElement(By.xpath('//*[@id="app"]/div/div[2]/div/div[2]/div[1]/input[1]')).sendKeys('Tom')
driver.sleep(1000)
driver.findElement(By.xpath('//*[@id="app"]/div/div[2]/div/div[2]/div[1]/input[2]')).sendKeys('Hallo du ficker')
console.log('End')
